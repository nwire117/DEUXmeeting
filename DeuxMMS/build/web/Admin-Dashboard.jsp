...
<link rel="stylesheet" href="Admin-Dashboard.css" media="screen">
  ...
  <body class="u-body"><header class="u-clearfix u-custom-color-5 u-header u-header" id="sec-6a01"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-align-center-lg u-align-center-md u-align-center-xl u-align-left-xs u-align-right-sm u-clearfix u-white u-section-1" id="carousel_5093">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-image u-image-circle u-image-1" alt="" data-image-width="1280" data-image-height="1248"></div>
        <h4 class="u-text u-text-default u-text-1">Welcome!</h4>
        <h1 class="u-text u-text-default u-text-2">ADMIN DASHBOARD</h1>
        <div class="u-clearfix u-expanded-width u-gutter-22 u-layout-wrap u-layout-wrap-1">
          <div class="u-layout">
            <div class="u-layout-col">
              <div class="u-size-40">
                <div class="u-layout-row">
                  <div class="u-align-center u-container-style u-layout-cell u-opacity u-opacity-70 u-palette-4-light-1 u-radius-20 u-size-20 u-layout-cell-1">
                    <div class="u-container-layout u-valign-bottom u-container-layout-1"><span class="u-icon u-icon-circle u-text-black u-icon-1"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 511 511" style=""><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-4914"></use></svg><svg class="u-svg-content" viewBox="0 0 511 511" id="svg-4914"><g><path d="m465.5 98.787-98.787-98.787h-261.213v61h-60v450h360v-61h60zm-90-47.574 39.787 39.787h-39.787zm0 429.787h-300v-390h30v359h270zm-240-61v-390h210v91h90v299z"></path><path d="m284.5 150c-66.168 0-120 53.832-120 120s53.832 120 120 120 120-53.832 120-120-53.832-120-120-120zm0 210c-49.626 0-90-40.374-90-90s40.374-90 90-90 90 40.374 90 90-40.374 90-90 90z"></path><path d="m299.5 209.5h-30v45h-45v30h45v45h30v-45h45v-30h-45z"></path>
</g></svg></span>
                  ...
                  <div class="u-align-center u-container-style u-layout-cell u-opacity u-opacity-70 u-palette-4-light-1 u-radius-20 u-size-20 u-layout-cell-2">
                    <div class="u-container-layout u-container-layout-2"><span class="u-icon u-icon-circle u-icon-2"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 18.453 18.453" style=""><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-1c52"></use></svg><svg class="u-svg-content" viewBox="0 0 18.453 18.453" x="0px" y="0px" id="svg-1c52" style="enable-background:new 0 0 18.453 18.453;"><g><g><rect x="2.711" y="4.058" style="fill:currentColor;" width="8.23" height="1.334"></rect><path style="fill:currentColor;" d="M14.972,14.088c0.638-1.127,0.453-2.563-0.475-3.49c-0.549-0.549-1.279-0.852-2.058-0.852    c-0.779,0-1.51,0.303-2.059,0.852s-0.852,1.279-0.852,2.059c0,0.777,0.303,1.508,0.852,2.059c0.549,0.547,1.279,0.85,2.057,0.85    c0.507,0,0.998-0.129,1.434-0.375l3.262,3.262l1.101-1.102L14.972,14.088z M13.664,13.881c-0.652,0.652-1.796,0.652-2.448,0    c-0.675-0.676-0.675-1.773,0-2.449c0.326-0.326,0.762-0.506,1.225-0.506s0.897,0.18,1.224,0.506s0.507,0.762,0.507,1.225    S13.991,13.554,13.664,13.881z"></path><path style="fill:currentColor;" d="M13.332,16.3H1.857c-0.182,0-0.329-0.148-0.329-0.328V1.638c0-0.182,0.147-0.329,0.329-0.329    h11.475c0.182,0,0.328,0.147,0.328,0.329V8.95c0.475,0.104,0.918,0.307,1.31,0.597V1.638C14.97,0.735,14.236,0,13.332,0H1.857    C0.954,0,0.219,0.735,0.219,1.638v14.334c0,0.902,0.735,1.637,1.638,1.637h11.475c0.685,0,1.009-0.162,1.253-0.76l-0.594-0.594    C13.772,16.347,13.426,16.3,13.332,16.3z"></path><rect x="2.711" y="7.818" style="fill:currentColor;" width="8.23" height="1.334"></rect>
</g>
</g></svg></span>
                      ...
                      <div class="u-expanded-width u-form u-form-2">
                        <form action="meeting" method="POST" class="u-clearfix u-form-custom-backend u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form-4" style="padding: 10px;">
                          <div class="u-form-group u-form-select u-form-group-4">
                            ...
                            <div class="u-form-select-wrapper">
                              <select id="select-7aa9" name="select" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                                <option value="Item 1">Item 1</option>
                                <option value="Item 2">Item 2</option>
                                <option value="Item 3">Item 3</option>
                              </select>
                          ...
                          <div class="u-form-date u-form-group u-form-group-5">
                            <label for="date-2826" class="u-form-control-hidden u-label"></label>
                            <input type="date" placeholder="MM/DD/YYYY" id="date-2826" name="date" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
                          </div>
                          <div class="u-form-date u-form-group u-form-group-6">
                            <label for="date-b808" class="u-form-control-hidden u-label"></label>
                            <input type="date" placeholder="MM/DD/YYYY" id="date-b808" name="date-1" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
                          </div>
                          <div class="u-align-center u-form-group u-form-submit">
                            <a href="#" class="u-btn u-btn-submit u-button-style">Submit</a>
                            <input type="submit" value="submit" class="u-form-control-hidden">
                  ...
                  <div class="u-align-center u-container-style u-layout-cell u-opacity u-opacity-70 u-palette-4-light-1 u-radius-20 u-shape-round u-size-20 u-layout-cell-3">
                    <div class="u-container-layout u-valign-bottom u-container-layout-3"><span class="u-icon u-icon-circle u-icon-3"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 512 512" style=""><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-55b9"></use></svg><svg class="u-svg-content" viewBox="0 0 512 512" id="svg-55b9"><g><path d="m415.157 86.566-93.9 26.865c-.104.034-.208.068-.312.104-10.041 3.493-16.788 12.982-16.788 23.614v27.223h-92.79l106.051-106.05c5.858-5.858 5.858-15.355 0-21.213l-26.872-26.873c-13.647-13.648-35.853-13.648-49.5 0l-27.631 27.631-14.144-14.144c-15.596-15.597-40.974-15.597-56.572 0l-55.159 55.159c-15.596 15.597-15.596 40.975 0 56.572l14.144 14.144-27.631 27.631c-13.647 13.647-13.647 35.853 0 49.5l26.872 26.872c5.857 5.858 15.356 5.859 21.214 0l38.022-38.022v231.417c0 35.843 29.161 65.004 65.004 65.004h158.012c35.843 0 65.004-29.161 65.004-65.004 0-10.566 0-331.798 0-336.751.001-17.08-16.816-29.171-33.024-23.679zm-306.403 13.529 55.158-55.158c3.899-3.899 10.244-3.9 14.145 0l14.143 14.144-69.302 69.302-14.144-14.143c-3.899-3.9-3.899-10.245 0-14.145zm2.779 121.685-16.266-16.265c-1.95-1.95-1.95-5.123 0-7.073 10.495-10.495 161.616-161.615 166.993-166.992 1.951-1.95 5.122-1.95 7.073 0l16.265 16.266zm306.648 225.216c0 19.301-15.703 35.003-35.003 35.003h-158.012c-19.301 0-35.003-15.703-35.003-35.003v-252.622h228.018zm0-281.816-84.022-.807v-23.583l84.022-23.67z"></path><path d="m237.431 442.995c8.284 0 15-6.716 15-15v-179.617c0-8.284-6.716-15-15-15s-15 6.716-15 15v179.616c-.001 8.285 6.715 15.001 15 15.001z"></path><path d="m304.172 442.995c8.284 0 15-6.716 15-15v-179.617c0-8.284-6.716-15-15-15s-15 6.716-15 15v179.616c-.001 8.285 6.715 15.001 15 15.001z"></path><path d="m370.912 442.995c8.284 0 15-6.716 15-15v-179.617c0-8.284-6.716-15-15-15s-15 6.716-15 15v179.616c0 8.285 6.716 15.001 15 15.001z"></path>
</g></svg></span>
              ...
              <div class="u-size-20">
                <div class="u-layout-row">
                  <div class="u-align-center u-container-style u-layout-cell u-opacity u-opacity-70 u-palette-4-light-1 u-radius-20 u-shape-round u-size-30 u-layout-cell-4">
                  ...
                  <div class="u-container-style u-layout-cell u-opacity u-opacity-70 u-palette-4-light-1 u-radius-20 u-size-30 u-layout-cell-5">
                    <div class="u-container-layout u-container-layout-5"><span class="u-icon u-icon-circle u-text-black u-icon-5"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 512 512" style=""><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-ac2c"></use></svg><svg class="u-svg-content" viewBox="0 0 512 512" x="0px" y="0px" id="svg-ac2c" style="enable-background:new 0 0 512 512;"><g><g><path d="M256,105.999c-57.891,0-105,47.109-105,105s47.109,105,105,105s105-47.109,105-105S313.891,105.999,256,105.999z     M211,165.999c8.284,0,15,6.714,15,15c0,8.284-6.716,15-15,15s-15-6.716-15-15C196,172.714,202.716,165.999,211,165.999z     M309.027,266.575c-5.86,5.86-15.351,5.86-21.211,0c-17.549-17.549-46.084-17.549-63.633,0c-5.859,5.859-15.352,5.859-21.211,0    c-5.859-5.859-5.859-15.352,0-21.211c29.238-29.238,76.816-29.238,106.055,0C314.887,251.224,314.887,260.716,309.027,266.575z     M301,195.999c-8.284,0-15-6.716-15-15c0-8.286,6.716-15,15-15s15,6.714,15,15C316,189.283,309.284,195.999,301,195.999z"></path>
</g>
</g><g><g><path d="M467,15.999H45c-24.814,0-45,20.186-45,45v300c0,24.814,20.186,45,45,45h46v75c0,13.376,16.224,19.987,25.605,10.605    l85.605-85.605H467c24.814,0,45-20.186,45-45v-300C512,36.185,491.814,15.999,467,15.999z M256,345.999    c-74.443,0-135-60.557-135-135s60.557-135,135-135s135,60.557,135,135S330.443,345.999,256,345.999z"></path>
</g>
</g></svg></span>
